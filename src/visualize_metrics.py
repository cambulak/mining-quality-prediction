...
# --- GARANTİ YOL BULMA ---
# Bu scriptin (visualize_metrics.py) nerede olduğunu bul
current_dir = os.path.dirname(os.path.abspath(__file__))

# Bir üst klasöre çık (Proje Ana Dizini) ve 'reports' klasörünü hedefle
output_folder = os.path.join(current_dir, '..', 'reports')
